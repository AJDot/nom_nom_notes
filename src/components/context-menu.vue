<template>
  <div ref="mask" class="w-screen h-screen z-50 fixed top-0 left-0 bg-transparent" tabindex="-1" @click.self="handleOutsideClick" @keyup.esc="handleOutsideClick">
    <div ref="context" :style="style" tabindex="0" class="hidden" @blur="close" @click="close">
      <slot />
    </div>
  </div>
</template>
