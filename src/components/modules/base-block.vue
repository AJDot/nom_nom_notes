<template>
  <component class="gap-4 justify-start whitespace-pre-wrap border border-gray-300 transition-background focus:bg-gray-100 focus:shadow-input" :is="componentMap[block.type]" :data-id="block.id" :block="block" :director="director" @input.stop="onInput" @keydown.enter.stop="onEnter" @keydown.arrow-down.stop="onArrowDown" @keydown.arrow-up.stop="onArrowUp" @keydown.delete.stop="onDelete" :draggable="draggable" :droppable="droppable" />
</template>
